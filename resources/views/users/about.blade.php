      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4 mb-5">
          <div class="block-38 text-center">
            <div class="block-38-img">
              <div class="block-38-header">
                <img src="{{ asset('template_user/images/person_3.jpg') }}" alt="Image placeholder" class="mb-4">
        ...
        <div class="col-md-6 col-lg-4 mb-5">
          <div class="block-38 text-center">
            <div class="block-38-img">
              <div class="block-38-header">
                <img src="{{ asset('template_user/images/person_4.jpg') }}" alt="Image placeholder" class="mb-4">
