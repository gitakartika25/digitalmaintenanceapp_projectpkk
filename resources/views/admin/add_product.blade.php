        ...
        <div class="card-body ">
            ...
            <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="product" placeholder="input product's name...">
                </div>
                <div class="mb-3">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="specification" placeholder="input specification...">
                </div>
                <div class="form-group">
                    <label for="exampleInputName1">Packaging</label>
                    <input type="text" class="form-control" name="packaging" placeholder="input packaging...">
                </div>
                <div class="form-group">
                    <label for="exampleInputName1">Material</label>
                    <input type="text" class="form-control" name="material" placeholder="input material...">
                </div>
                <div class="form-group">
